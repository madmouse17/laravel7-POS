                ...
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="payment" type="text" class="form-control" name="payment" placeholder="Cash..." data-bind="textInput: payment">
                                    </div>
                                    <div class="form-group">
                                        <div class="d-flex">
                    ...
                    <div class="col-md-4">
                        <div class="card-action">
                            <button id="submitButton" class="btn btn-warning btn-round align-right shadow">
